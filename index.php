...
<body>
    <div class="login-overlay" id="loginOverlay">
        <div class="login-container">
            ...
            <button class="login-btn" onclick="checkPassword()">Zaloguj się</button>
        </div>
    </div>
    <script>
        ...
        if (hour >= 18) {
            document.querySelector('.login-welcome').textContent = 'Dobry wieczór!';
        }

        // Prevent access to main content
...
<div class="button-container">
    ...
    <a class="go">wejdź</a>
    <div class="instagram" onclick="window.open('https://www.instagram.com/ryba_elektryk/')">
